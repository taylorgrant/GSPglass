...
# load packages
pacman::p_load(tidyverse, janitor, here, glue, scales, 
               highcharter, DT, htmltools, broom)

# read in the data and split out 
# data <- params$data
...
year_avg <- fulldata |> 
  ...
  dplyr::group_by(year) |> summarise(avg = mean(rating, na.rm = TRUE))
```
